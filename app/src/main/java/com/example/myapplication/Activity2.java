    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fromDropMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fromDialog = new Dialog(Activity2.this);
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(Activity2.this, android.R.layout.simple_list_item_1, arrayList);
        ...
        toDropMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toDialog = new Dialog(Activity2.this);
        ...
        convBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Double amountToConv = Double.valueOf(Activity2.this.amountToConvert.getText().toString());
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    NotificationCompat.Builder builder = new NotificationCompat.Builder(Activity2.this, "myNotif");
